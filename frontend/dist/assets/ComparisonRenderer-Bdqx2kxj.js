import{r as p,j as a}from"./index-wQW5iGBW.js";const x=`
...
`;function u({data:h}){const c=h.items||[],b=c.length<=2?"cols-2":c.length===3?"cols-3":"cols-4",d=p.useRef({names:new Set,prosMap:{},consMap:{}}),n=d.current,m=new Set,f={},g={};return c.forEach(e=>{n.names.has(e.name)||m.add(e.name);const l=n.prosMap[e.name]||[],t=n.consMap[e.name]||[],r=new Set,o=new Set;(e.pros||[]).forEach((i,s)=>{(s>=l.length||l[s]!==i)&&r.add(s)}),(e.cons||[]).forEach((i,s)=>{(s>=t.length||t[s]!==i)&&o.add(s)}),f[e.name]=r,g[e.name]=o}),p.useEffect(()=>{d.current={names:new Set(c.map(e=>e.name)),prosMap:Object.fromEntries(c.map(e=>[e.name,[...e.pros||[]]])),consMap:Object.fromEntries(c.map(e=>[e.name,[...e.cons||[]]]))}},[c]),a.jsxs(a.Fragment,{children:[a.jsx("style",{children:x}),a.jsx("div",{className:`cmp-grid ${b}`,children:c.map((e,l)=>a.jsxs("div",{className:`cmp-card${m.has(e.name)?" cmp-enter":""}`,children:[a.jsx("div",{className:"cmp-name",children:e.name}),e.description&&a.jsx("div",{className:"cmp-desc",children:e.description}),e.pros&&e.pros.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"cmp-section-label pros",children:"Pros"}),a.jsx("ul",{className:"cmp-list pros",children:e.pros.map((t,r)=>{var o;return a.jsx("li",{className:(o=f[e.name])!=null&&o.has(r)?"cmp-li-enter":"",children:t},r)})})]}),e.cons&&e.cons.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"cmp-section-label cons",children:"Cons"}),a.jsx("ul",{className:"cmp-list cons",children:e.cons.map((t,r)=>{var o;return a.jsx("li",{className:(o=g[e.name])!=null&&o.has(r)?"cmp-li-enter":"",children:t},r)})})]}),e.stats&&e.stats.length>0&&a.jsx("div",{className:"cmp-stats",children:e.stats.map((t,r)=>a.jsxs("div",{className:"cmp-stat",children:[a.jsx("span",{className:"cmp-stat-label",children:t.label}),a.jsx("span",{className:"cmp-stat-value",children:t.value})]},r))})]},e.name))})]})}const v=p.memo(u);export{v as default};
