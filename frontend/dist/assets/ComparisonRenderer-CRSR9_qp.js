import{a as i,j as a}from"./index-DHeYubZx.js";const n=`
...
`;function d({data:r}){const o=r.items||[],s=o.length<=2?"cols-2":o.length===3?"cols-3":"cols-4";return a.jsxs(a.Fragment,{children:[a.jsx("style",{children:n}),a.jsx("div",{className:`cmp-grid ${s}`,children:o.map((e,l)=>a.jsxs("div",{className:"cmp-card",children:[a.jsx("div",{className:"cmp-name",children:e.name}),e.description&&a.jsx("div",{className:"cmp-desc",children:e.description}),e.pros&&e.pros.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"cmp-section-label pros",children:"Pros"}),a.jsx("ul",{className:"cmp-list pros",children:e.pros.map((t,c)=>a.jsx("li",{children:t},c))})]}),e.cons&&e.cons.length>0&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"cmp-section-label cons",children:"Cons"}),a.jsx("ul",{className:"cmp-list cons",children:e.cons.map((t,c)=>a.jsx("li",{children:t},c))})]}),e.stats&&e.stats.length>0&&a.jsx("div",{className:"cmp-stats",children:e.stats.map((t,c)=>a.jsxs("div",{className:"cmp-stat",children:[a.jsx("span",{className:"cmp-stat-label",children:t.label}),a.jsx("span",{className:"cmp-stat-value",children:t.value})]},c))})]},l))})]})}const m=i.memo(d);export{m as default};
