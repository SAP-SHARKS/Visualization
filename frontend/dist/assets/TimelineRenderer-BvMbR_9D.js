import{b as l,j as t}from"./index-dpbyM5Yg.js";const o=`
...
`;function r({data:a}){const i=a.events||[];return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:o}),t.jsxs("div",{className:"tl-container",style:{width:"100%"},children:[t.jsx("div",{className:"tl-line"}),i.map((e,n)=>t.jsxs("div",{className:"tl-event",children:[t.jsxs("div",{className:"tl-card",children:[e.icon&&t.jsx("div",{className:"tl-icon",children:e.icon}),t.jsx("div",{className:"tl-date",children:e.date}),t.jsx("div",{className:"tl-title",children:e.title}),t.jsx("div",{className:"tl-desc",children:e.description})]}),t.jsx("div",{className:"tl-dot"})]},n))]})]})}const s=l.memo(r);export{s as default};
