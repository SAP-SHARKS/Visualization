import{a as i,j as t}from"./index-Dqb8_brs.js";const l=`
...
`;function o({data:a}){const r=a.events||[];return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:l}),t.jsxs("div",{className:"tl-container",style:{width:"100%"},children:[t.jsx("div",{className:"tl-line"}),r.map((e,n)=>t.jsxs("div",{className:"tl-event",children:[t.jsxs("div",{className:"tl-card",children:[e.icon&&t.jsx("div",{className:"tl-icon",children:e.icon}),t.jsx("div",{className:"tl-date",children:e.date}),t.jsx("div",{className:"tl-title",children:e.title}),t.jsx("div",{className:"tl-desc",children:e.description})]}),t.jsx("div",{className:"tl-dot"})]},n))]})]})}const s=i.memo(o);export{s as default};
